     ...
     <?php $__env->slot('header', null, []); ?> 
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
             ...
             <form method="post" action="<?php echo e(route('customer.search')); ?>" class="flex items-center gap-3">
                    <?php echo csrf_field(); ?>
                ...
                <table class="w-full">
                    ...
                    <tbody class="bg-white">
                        <?php if($customers->isNotEmpty()): ?>
                            ...
                            <tr class="border-b" >
                                <td class="px-6 py-3 text-left"><?php echo e($customer->id); ?></td>
                                <td class="px-6 py-3 text-left"><?php echo e($customer->name); ?></td>
                                <td class="px-6 py-3 text-left"><?php echo e($customer->contact); ?></td>
                                <td class="px-6 py-3 text-left"><?php echo e($customer->alt_contact ?? '-'); ?></td>
                                <td class="px-6 py-3 text-left"><?php echo e($customer->vehicle_registration ?? '-'); ?></td>
                                <td class="px-6 py-3 text-left"><?php echo e($customer->address); ?></td>
                                <td class="px-6 py-3 text-left"><?php echo e(\Carbon\Carbon::parse($customer->created_at)->format('d M, Y')); ?></td>
...
<?php endif; ?>
<?php /**PATH /Applications/MAMP/htdocs/raoenergy/resources/views/customer/index.blade.php ENDPATH**/ ?>