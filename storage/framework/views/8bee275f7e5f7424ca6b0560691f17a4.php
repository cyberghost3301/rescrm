                ...
                <table class="w-full">
                    ...
                    <tbody class="bg-white">
                        <?php if($loans->isNotEmpty()): ?>
                            ...
                            <tr class="border-b" >
                                <td class="px-6 py-3 text-left"><?php echo e($loan->id); ?></td>
                                <td class="px-6 py-3 text-left"><?php echo e($loan->customer->name); ?></td>
                                <td class="px-6 py-3 text-left"><?php echo e($loan->invoice_number); ?></td>
                                <td class="px-6 py-3 text-left"><?php echo e(\Carbon\Carbon::parse($loan->created_at)->format('d M, Y')); ?></td>
                                <td class="px-6 py-3 text-center">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create edit')): ?>

                                <a href="<?php echo e(route('loans.show', $loan->id)); ?>"> 
                                    <?php if (isset($component)) { $__componentOriginald411d1792bd6cc877d687758b753742c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald411d1792bd6cc877d687758b753742c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'ms-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('primary-button'); ?>
...
<?php endif; ?>
                                ...
                                <a href="<?php echo e(route('loans.agreement',$loan->id)); ?>">
                                    <?php if (isset($component)) { $__componentOriginald411d1792bd6cc877d687758b753742c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald411d1792bd6cc877d687758b753742c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'ms-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('primary-button'); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'ms-3']); ?>
                                        <?php echo e(__('generate Agreement')); ?>  
                                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald411d1792bd6cc877d687758b753742c)): ?>
<?php $attributes = $__attributesOriginald411d1792bd6cc877d687758b753742c; ?>
...
<?php endif; ?>
<?php /**PATH /home/u384460131/domains/theglobaleworld.com/public_html/raoenergy/resources/views/loans/index.blade.php ENDPATH**/ ?>