    ...
    <form method="post" action="<?php echo e(route('invoice.search')); ?>" class="flex flex-col sm:flex-row items-center gap-3 mb-6">
      <?php echo csrf_field(); ?>
        <input type="text" name="invoice" placeholder="Enter Invoice Number"
               class="flex-1 px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-gray-700 focus:outline-none" required>
        <button type="submit" 
...
<?php /**PATH /home/u384460131/domains/theglobaleworld.com/public_html/raoenergy/resources/views/welcome.blade.php ENDPATH**/ ?>