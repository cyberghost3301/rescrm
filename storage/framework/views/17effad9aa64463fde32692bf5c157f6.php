    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div class="bg-white p-6 rounded-lg shadow-md">
                    <h3 class="text-sm text-gray-500">Pending / Overdue Amount</h3>
                    <p class="text-2xl font-bold text-red-600">₹ 0</p>
                </div>
                <div class="bg-white p-6 rounded-lg shadow-md">
                    <h3 class="text-sm text-gray-500">Upcoming Collections (Next 7 Days)</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    <h3 class="text-sm text-gray-500">New This Month</h3>
            ...
            <!-- Recent Transactions -->
            <h3 class="text-xl font-semibold mt-8 mb-4">💰 Recent Collections</h3>
            <div class="bg-white p-6 rounded-lg shadow-md">
                <table class="min-w-full border border-gray-200">
                    ...
                    <tbody>
                        <tr>
                            <td class="px-4 py-2 border">Ramesh</td>
                            <td class="px-4 py-2 border">₹ 500</td>
                            <td class="px-4 py-2 border">2025-09-05</td>
                            <td class="px-4 py-2 border text-green-600">Paid</td>
                        </tr>
                        <tr>
                            <td class="px-4 py-2 border">Suresh</td>
                            <td class="px-4 py-2 border">₹ 1000</td>
                            <td class="px-4 py-2 border">2025-09-04</td>
                            <td class="px-4 py-2 border text-red-600">Pending</td>
                        </tr>
                        <tr>
...
<?php endif; ?>
<?php /**PATH /Applications/MAMP/htdocs/raoenergy/resources/views/dashboard.blade.php ENDPATH**/ ?>