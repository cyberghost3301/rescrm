     ...
     <?php $__env->slot('header', null, []); ?> 
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <?php echo e(__('Permissions List')); ?>
...
<?php $component->withAttributes(['name' => 'confirm-user-deletion','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->userDeletion->isNotEmpty()),'focusable' => true]); ?>
        <form method="post" action="<?php echo e(route('permissions.destroy',$permission->id)); ?>" class="p-6">
            <?php echo csrf_field(); ?>
            ...
            <p class="mt-1 text-sm text-gray-600">
                <?php echo e(__('Once your permission is deleted, all of its resources and data will be permanently deleted.')); ?>
...
<?php endif; ?>
<?php /**PATH /home/u384460131/domains/theglobaleworld.com/public_html/raoenergy/resources/views/permissions/index.blade.php ENDPATH**/ ?>