...
<body>
    <div class="header">
        ...
        line-height: 28px;
        margin: 0;
        padding: 0;">राव एनर्जी सॉल्यूशंस</div>
...
<br><br>
   ...
   <div class="devanagari header"> साप्ताहिक किश्त भुगतान अनुबंध/शपथ पत्र</div>
    ...
    <p>
    मैं    <?php echo e($loan->customer->name); ?>  पुत्र/पुत्री/पत्नी <?php echo e(explode(',', $loan->customer->address)[0] ?? 'N/A'); ?>
    ...
    <p>मैं प्रत्येक सप्ताह के <?php echo e($loan->weekly_installment_day); ?> के दिन अपना साप्ताहिक किश्त जो कि ₹ 
    ...
    <p>मैं अगर <?php echo e($loan->finance_period_weeks/4); ?> साप्ताहिक किश्त नहीं जमा करता/करती हूँ तो 
        ...
        <p>मैं अगर <?php echo e($loan->finance_period_weeks/2); ?>  सप्ताह में कुल बकाया धनराशि का आधा नहीं जमा करता/करती हूँ तो मैं क्रय की हुई बैटरियां राव एनर्जी सॉल्यूशंस को वापस लेने की 
            स्वैच्छिक अनुमति देता/देती हूँ एवं किसी भी प्रकार के कोई भुगतान एवं अपने द्वारा दी गयी पुराने बैटरी की वापसी का दावा नहीं करूंगा/करूंगी।</p>
    
    <p>मैं अगर <?php echo e($loan->finance_period_weeks); ?> सप्ताह में कुल बकाया धनराशि नहीं जमा करता/करती हूँ तो मैं क्रय की हुई बैटरियां 
    ...
    <p>जिस सप्ताह मैं साप्ताहिक किश्त नहीं जमा करता/करती हूँ उस सप्ताह के अंत में मैं ₹ 200 non payment penalty के रूप में राव एनर्जी सॉल्यूशंस को 
    ...
    <p>मैं राव एनर्जी सॉल्यूशन्स को बैटरी वापस देने के एक सप्ताह के भीतर अपना कुल बकाया भुगतान करने में असफल होता/होती हूँ 
        तो राव एनर्जी सॉल्यूशन्स को सभी बैटरी बेच कर अपना बकाया वसूल करने की अनुमति प्रदान करता/करती हूँ ।</p>
   
    <p>अगर  <?php echo e($loan->finance_period_weeks); ?>  सप्ताह में कुल बकाया धनराशि ( जिसमें non payment penalty और late payment penalty शामिल है ) मैं नहीं अदा कर पाता/पाती हूँ और राव एनर्जी सॉल्यूशंस क्रय की हुईं बैटरियां वापस नहीं लेते है तो मैं बकाया धनराशि ( जिसमें non payment penalty और late payment penalty शामिल है ) पर 1% late payment penalty के रूप में प्रत्येक सप्ताह के अंत में बकाया धनराशि में बढ़ाने की अनुमति राव एनर्जी सॉल्यूशंस को देता/देती हूँ।</p>
    <br><br>
    <p>दिनांक: <?php echo e(\Carbon\Carbon::parse($loan->sale_date)->format('d-m-Y')); ?> </p> 
    <p>स्थान: पगरा उर्फ परसिया, भीखमपुर रोड, देवरिया, उत्तर प्रदेश, 274001</p>
    <br>
    <p>हस्ताक्षर</p>
...
<?php /**PATH /Applications/MAMP/htdocs/raoenergy/resources/views/loans/agreement.blade.php ENDPATH**/ ?>