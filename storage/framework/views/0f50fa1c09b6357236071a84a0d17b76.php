   ...
   <?php $__env->slot('header', null, []); ?> 
       ...
       <div class="flex items-center justify-between mt-4">
           ...
           <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            ...
            <a href="<?php echo e(route('cashIn.index')); ?>"> 
...
<?php endif; ?>
  ...
  <form method="post" action="<?php echo e(route('cashIn.store')); ?>">
    <?php echo csrf_field(); ?>
  ...
  <div class="bg-white p-6 rounded-xl shadow mb-5 mt-5">
      ...
      <table class="w-full">
                    ...
                    <tbody class="bg-white">
                        <?php if($cashIns->isNotEmpty()): ?>
                            <?php $__currentLoopData = $cashIns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cashIn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b" >
                                <td class="px-6 py-3 text-left"><?php echo e($cashIn->id); ?></td>
                                <td class="px-6 py-3 text-left"><?php echo e(\Carbon\Carbon::parse($cashIn->entry_date)->format('d M, Y')); ?></td>
                                <td class="px-6 py-3 text-left"> <?php echo e($cashIn->amount); ?></td>
                                <td class="px-6 py-3 text-left"><?php echo e($cashIn->note); ?></td>
...
<?php endif; ?>
<?php /**PATH /home/u384460131/domains/theglobaleworld.com/public_html/raoenergy/resources/views/expenses/cashIn_create.blade.php ENDPATH**/ ?>