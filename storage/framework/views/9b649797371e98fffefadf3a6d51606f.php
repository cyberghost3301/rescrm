...
<body>
    ...
    <tr>
        ...
        <td><?php echo e($loan->sale_date); ?></td>

        <td class="label">Closure Date:</td>
        <td><?php echo e($loan->closure_date); ?></td>
    </tr>
...
<?php /**PATH /Applications/MAMP/htdocs/raoenergy/resources/views/loans/pdf.blade.php ENDPATH**/ ?>