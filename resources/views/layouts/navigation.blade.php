    ...
    <div class="flex justify-between items-center h-16">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dayaction.index')" :active="request()->routeIs('dayaction.index')">
                        {{ __('Day Action') }}
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('cashIn.index')" :active="request()->routeIs('cashIn.index')">
                        {{ __('Ledger') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('cashHolding.index')" :active="request()->routeIs('cashHolding.index')">
                        {{ __('Cash Holding') }}
                    </x-nav-link>
                </div>
                
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('prospect.index')" :active="request()->routeIs('prospect.index')">
                        {{ __('Prospects') }}
                    </x-nav-link>
                </div>
...
<div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
    <div class="pt-2 pb-3 space-y-1">
        ...
        <x-responsive-nav-link :href="route('dayaction.index')" :active="request()->routeIs('dayaction.index')">
            {{ __('Day Action') }}
        </x-responsive-nav-link>
        ...
        <x-responsive-nav-link :href="route('cashHolding.index')" :active="request()->routeIs('cashHolding.index')">
            {{ __('Cash Holding') }}
        </x-responsive-nav-link>
